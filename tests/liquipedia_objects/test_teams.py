...
GEAR = dict(zip(PLAYERS, [1,3]))
GEAR_CROSSHAIR_html = dict(zip(PLAYERS, [9,9]))

GEAR_CROSSHAIR_wc = dict(zip(PLAYERS, [6,6]))
...
class TestPlayers(unittest.TestCase):
    ...
    def test_gear_html(self):
        ...
        self.setup_test_players(PLAYERS, GEAR, "get_gear", mode="html")
    def test_gear_wc(self):
        """Validate gear counts using WC parse."""
        self.setup_test_players(PLAYERS, GEAR, "get_gear", mode="wikicode")
